...
param(
    ...
    [ValidateSet("full", "posttrain-grpo", "replay-refresh", "side-lora", "v1-pretrain-posttrain", "synthetic-v1-pretrain-posttrain", "synthetic-gb-side-lora", "synthetic-gb-side-lora-long")]
    [string]$Profile = "full"
)
